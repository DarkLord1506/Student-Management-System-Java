...
#pos{
    ...
    <body>
      ...
      <marquee scrollamount="20" width="95%" ">Student Record&nbsp;</marquee>
    ...
    <%
        ...
        ResultSet rs;
         ...
         try{          
             ...
             <div id="pos">
                 <h1>Options</h1>
                 <a href="subjectselect.jsp?rno=<%=request.getParameter("rno")%>">Select Subjects</a><br><br>
                    <a href="showmarks.jsp?rno=<%=request.getParameter("rno")%>">Show Marks</a><br><br>
