...
#student tr:hover {background: whitesmoke;
color: black;}
...
hr { 
  ...
  border-width: 1px;
    ...
    <body>
      ...
      <marquee scrollamount="20" width="95%" ">ADD Student MARKS&nbsp;</marquee>
      <a href="main.jsp" style="float:right; ">Back</a>
</nav>
        
        <div id="Edit">
       
            <p align='center'> ADD Student Marks</p>
            <hr>
        ...
        ResultSet rs,rs1;
         ...
         try{          
               ...
               int roll = Integer.parseInt(request.getParameter("rno"));
                ...
                String q1="select * from subjects  where rollno="+roll;
                ...
                <form action="marksadd" method="post">
                    <input type="text" value="<%=roll%>" name="rn" hidden>
                    <table id="student">
                    <tr>
                        <th>S.NO</th>
                        <th>Subject</th>
